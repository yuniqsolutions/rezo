...
export const WEB_ASSET_EXTENSIONS = [
  ".css",
  ".scss",
  ".sass",
  ".less",
...
export const WEB_ASSET_MIME_TYPES = [
  "text/css",
  "text/javascript",
...
export const DOCUMENTS_ONLY_PRESET = {
  acceptAssetTypes: ["document"]
};
export const NO_MEDIA_PRESET = {
  excludeExtensions: [
    ...VIDEO_EXTENSIONS,
    ...AUDIO_EXTENSIONS
  ],
...
export const MINIMAL_MIRROR_PRESET = {
