...
export function createFetchStreamTransport(fetchImplOrModule, options = {}) {
...
export function createExpoFileSystemAdapter(expoFileSystem, options = {}) {
...
export function createReactNativeFsAdapter(rnfs, options = {}) {
  return {
...
export function createNetInfoProvider(netInfo) {
  return {
    async fetch() {
...
export function createExpoBackgroundTaskProvider(backgroundTask, taskManager) {
  return {
    registerTask(task) {
