...
function hasXssiPrefix(str) {
  const trimmed = str.trimStart();
  return XSSI_PREFIXES.some((p) => trimmed.startsWith(p));
}
function stripXssiPrefix(str) {
...
exports.hasXssiPrefix = hasXssiPrefix;
exports.stripXssiPrefix = stripXssiPrefix;
exports.parseXssiJson = parseXssiJson;
exports.parseBatchExecute = parseBatchExecute;