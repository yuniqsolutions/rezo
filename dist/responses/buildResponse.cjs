...
function buildResponseFromIncoming(response, body, config, finalUrl, urls, optionalStatus, optionalStatusText, actualContentLength) {
...
function buildDownloadResponse(statusCode, statusMessage, headers, contentLength, cookies, url, finalUrl, urls, config) {
  return buildResponse({
    statusCode,
    statusMessage,
    headers,
...
exports.buildResponseFromIncoming = buildResponseFromIncoming;
exports.buildDownloadResponse = buildDownloadResponse;