const { firefoxTls, FIREFOX_H2, FIREFOX_ACCEPT, FIREFOX_HEADER_ORDER, FIREFOX_133_HEADER_ORDER } = require('./constants.cjs');
...
const FIREFOX_115 = exports.FIREFOX_115 = {
  id: "firefox-115",
  family: "firefox",
  engine: "gecko",
  version: "115.0",
...
const FIREFOX_121 = exports.FIREFOX_121 = {
  id: "firefox-121",
  family: "firefox",
  engine: "gecko",
  version: "121.0",
...
const FIREFOX_128 = exports.FIREFOX_128 = {
  id: "firefox-128",
  family: "firefox",
  engine: "gecko",
  version: "128.0",
...
const FIREFOX_133 = exports.FIREFOX_133 = {
  id: "firefox-133",
  family: "firefox",
  engine: "gecko",
  version: "133.0",
