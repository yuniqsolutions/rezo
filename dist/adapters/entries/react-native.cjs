...
const _mod_wt0yxp = require('../../platform/react-native-providers.cjs');
exports.createFetchStreamTransport = _mod_wt0yxp.createFetchStreamTransport;
exports.createExpoFileSystemAdapter = _mod_wt0yxp.createExpoFileSystemAdapter;
exports.createReactNativeFsAdapter = _mod_wt0yxp.createReactNativeFsAdapter;
exports.createNetInfoProvider = _mod_wt0yxp.createNetInfoProvider;
exports.createExpoBackgroundTaskProvider = _mod_wt0yxp.createExpoBackgroundTaskProvider;;
exports.Rezo = Rezo;
