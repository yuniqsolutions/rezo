...
const _mod_iamxdq = require('../../platform/react-native-providers.cjs');
exports.createFetchStreamTransport = _mod_iamxdq.createFetchStreamTransport;
exports.createExpoFileSystemAdapter = _mod_iamxdq.createExpoFileSystemAdapter;
exports.createReactNativeFsAdapter = _mod_iamxdq.createReactNativeFsAdapter;
exports.createNetInfoProvider = _mod_iamxdq.createNetInfoProvider;
exports.createExpoBackgroundTaskProvider = _mod_iamxdq.createExpoBackgroundTaskProvider;;
exports.Rezo = Rezo;
