...
declare class StreamResponse extends Writable implements StreamResponseEventOverrides {
	private _finished;
	private _encoding?;
	private _pipeTargets;
	/** Buffer early events so they can be replayed when listeners attach late (e.g. after await) */
	 ...
	 * Writes directly to pipe targets AND emits 'data' event
	 * @internal
	 */
	...
	/**
	 * Pipe stream data to a writable destination.
	 *
	 * @example
	 * ```typescript
	 * const stream = rezo.stream(url);
	 ...
	 * ```typescript
	 * const stream = rezo.stream(url);
	 * stream.pipeTo('./downloads/file.pdf');
	 * ```
	 */
	pipeTo(filePath: string): this;
	/**
	 * Buffer replayable events when no listeners are attached yet.
	 * @internal
	 */
	emit(event: string | symbol, ...args: any[]): boolean;
	on(event: string | symbol, listener: (...args: any[]) => void): this;
...
export interface DownloadResponseEventOverrides {
	...
	on(event: "finish", listener: (info: DownloadFinishEvent) => void): this;
	on(event: "done", listener: (info: DownloadFinishEvent) => void): this;
	on(event: "complete", listener: (info: DownloadFinishEvent) => void): this;
	on(event: "start", listener: (info: RequestStartEvent) => void): this;
	on(event: "initiated", listener: () => void): this;
	on(event: "headers", listener: (info: ResponseHeadersEvent) => void): this;
	on(event: "cookies", listener: (cookies: Cookie[]) => void): this;
	...
	once(event: "finish", listener: (info: DownloadFinishEvent) => void): this;
	once(event: "done", listener: (info: DownloadFinishEvent) => void): this;
	once(event: "complete", listener: (info: DownloadFinishEvent) => void): this;
	once(event: "start", listener: (info: RequestStartEvent) => void): this;
	once(event: "initiated", listener: () => void): this;
	once(event: "headers", listener: (info: ResponseHeadersEvent) => void): this;
	once(event: "cookies", listener: (cookies: Cookie[]) => void): this;
	...
	addListener(event: "complete", listener: (info: DownloadFinishEvent) => void): this;
	...
	addListener(event: "progress", listener: (progress: RezoProgressEvent) => void): this;
	addListener(event: string | symbol, listener: (...args: any[]) => void): this;
	...
	prependListener(event: "complete", listener: (info: DownloadFinishEvent) => void): this;
	...
	prependListener(event: "progress", listener: (progress: RezoProgressEvent) => void): this;
	prependListener(event: string | symbol, listener: (...args: any[]) => void): this;
	...
	prependOnceListener(event: "complete", listener: (info: DownloadFinishEvent) => void): this;
	...
	prependOnceListener(event: "progress", listener: (progress: RezoProgressEvent) => void): this;
	prependOnceListener(event: string | symbol, listener: (...args: any[]) => void): this;
}
...
/**
 * cURL version detection and capability checking
 */
export declare class CurlCapabilities {
	...
	private isAvailable;
	static getInstance(): CurlCapabilities;
	initialize(): Promise<void>;
	private checkCurlAvailability;
	private getCurlInstallationMessage;
...
export declare class CurlCommandBuilder {
	 ...
	 * These options override internal defaults when set
	 */
	private applyCurlOptions;
	/**
	 * Apply comprehensive TLS options
	 */
	private applyTlsOptions;
	/**
	 * Apply proxy TLS options
	 */
	private applyProxyTlsOptions;
	/**
	 * Apply FTP options
	 */
	private applyFtpOptions;
	/**
	 * Apply SSH options
	 */
	private applySshOptions;
	/**
	 * Apply SMTP options
	 */
	private applySmtpOptions;
	/**
	 * Apply SSL version flag
	 */
	private applySslVersion;
	/**
	 * Apply proxy SSL version flag
	 */
	private applyProxySslVersion;
	/**
	 * Replace an existing argument value or add if not present
	 */
	private replaceArg;
	/**
	 * Remove an argument from the args array
	 */
	private removeArg;
	private addArg;
	...
	private configureProxyByProtocol;
